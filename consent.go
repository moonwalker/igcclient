...
func (s *ConsentService) GetConsents(languageAlpha2Code string, headers map[string]string) (response OperationResponseOfListOfPublicConsentModel, err error) {
...
func (s *ConsentService) HasPendingConsents(headers map[string]string) (response OperationResponseOfBoolean, err error) {
...
func (s *ConsentService) RequiresLegacyUpdate(headers map[string]string) (response OperationResponseOfBoolean, err error) {
...
func (s *ConsentService) UserPendingConsents(languageAlpha2Code string, headers map[string]string) (response OperationResponseOfPublicUserConsentsListModel, err error) {
	err = s.client.apiPost("/Consent/UserPendingConsents?languageAlpha2Code="+languageAlpha2Code, nil, &response, &headers)
	return
}

// Save user consents
func (s *ConsentService) SaveUserConsents(body []ConsentVersionSaveModel, userID int64, headers map[string]string) (response OperationResponseOfBoolean, err error) {
...
func (s *ConsentService) UserConsents(languageAlpha2Code string, headers map[string]string) (response OperationResponseOfPublicUserConsentsListModel, err error) {
...
func (s *ConsentService) Unsubscribe(triggerCode string, userID int64, headers map[string]string) (response OperationResponseOfObject, err error) {
