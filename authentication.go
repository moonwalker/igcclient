...
func (s *AuthenticationService) Login(loginModel LoginModel) (response OperationResponseOfNullableIfGuid, err error) {
	err = s.client.apiPost("/authentication/login", &loginModel, &response, nil, nil)
	return
}

// Checks if the User is logged in
func (s *AuthenticationService) IsLoggedIn(authToken string) (response OperationResponseOfBoolean, err error) {
	err = s.client.apiPost("/authentication/isloggedin", nil, &response, nil, &authToken)
	return
}

// Logout the User
func (s *AuthenticationService) Logout(authToken string) (response OperationResponseOfBoolean, err error) {
	err = s.client.apiPost("/authentication/logout", nil, &response, nil, &authToken)
	return
}
...
func (s *AuthenticationService) GetPasswordRegex() (response OperationResponseOfString, err error) {
	err = s.client.apiPost("/v2/authentication/getpasswordregex", nil, &response, nil, nil)
	return
}
...
func (s *AuthenticationService) VerifyActivationTokenGet(body GetVerificationTokenModel) (response OperationResponseOfGuid, err error) {
	err = s.client.apiPost("/v2/authentication/verify/activationtoken/get", &body, &response, nil, nil)
	return
}
...
func (s *AuthenticationService) VerifySMSSend(body ShortMessageServiceModel) (response OperationResponseOfBoolean, err error) {
	err = s.client.apiPost("/v2/authentication/verify/sms/send", &body, &response, nil, nil)
	return
}
...
func (s *AuthenticationService) VerifySMS(body VerifyUserBySMSModel) (response OperationResponseOfString, err error) {
	err = s.client.apiPost("/v2/authentication/verify/sms", &body, &response, nil, nil)
	return
}
...
func (s *AuthenticationService) VerifyEmail(verificationCode string) (response OperationResponseOfGuid, err error) {
	err = s.client.apiPost("/Authentication/Verify/Email/"+url.QueryEscape(verificationCode), nil, &response, nil, nil)
	return
}
...
func (s *AuthenticationService) VerifyEmailSend(email string) (response OperationResponseOfBoolean, err error) {
	err = s.client.apiPost("/authentication/verify/email/send?email="+url.QueryEscape(email), nil, &response, nil, nil)
	return
}

// Allows to bind UserAgent and IP to the authentication token
// param: New IP and User Agent to bind to
func (s *AuthenticationService) AllowIP(body AllowIPModel, authToken string) (response OperationResponse, err error) {
	err = s.client.apiPost("/authentication/allow/ip", &body, &response, nil, &authToken)
	return
}
...
func (s *AuthenticationService) SecurityQuestion(body EmailModel) (response OperationResponseOfSecurityQuestion, err error) {
	err = s.client.apiPost("/authentication/securityquestion", &body, &response, nil, nil)
	return
}

// Change User's password
func (s *AuthenticationService) ChangePassword(body ChangePasswordModel, authToken string) (response OperationResponse, err error) {
	err = s.client.apiPost("/authentication/change/password", &body, &response, nil, &authToken)
	return
}

// Change User's Email Address
func (s *AuthenticationService) ChangeEmail(body ChangeEmailModel, authToken string) (response OperationResponse, err error) {
	err = s.client.apiPost("/authentication/change/email", &body, &response, nil, &authToken)
	return
}

// Change User's Security Question
func (s *AuthenticationService) ChangeSecurityQuestion(body ChangeSecurityQuestionModel, authToken string) (response OperationResponse, err error) {
	err = s.client.apiPost("/authentication/change/securityquestion", &body, &response, nil, &authToken)
	return
}

// Start Forgot Password Process
func (s *AuthenticationService) ForgotPassword(body ForgotPasswordModel) (response OperationResponse, err error) {
	err = s.client.apiPost("/authentication/forgotpassword", &body, &response, nil, nil)
	return
}
...
func (s *AuthenticationService) ForgotPasswordSMS(body ShortMessageServiceModel) (response OperationResponse, err error) {
	err = s.client.apiPost("/authentication/forgotpassword/sms", &body, &response, nil, nil)
	return
}
...
func (s *AuthenticationService) ForgotPasswordChangeSMS(body ForgotPasswordChangeBySMSModel) (response OperationResponse, err error) {
	err = s.client.apiPost("/authentication/forgotpassword/change/sms", &body, &response, nil, nil)
	return
}
...
func (s *AuthenticationService) ForgotPasswordChange(body ForgotPasswordChangeModel) (response OperationResponse, err error) {
	err = s.client.apiPost("/authentication/forgotpassword/change", &body, &response, nil, nil)
	return
}
...
func (s *AuthenticationService) Register(body RegistrationData) (response OperationResponseOfDictionaryOfStringAndString, err error) {
	err = s.client.apiPost("/v2/authentication/register", &body, &response, nil, nil)
	return
}
