...
func (s *PaymentsService) GetUserWithdrawMethods(countryID int64, userID int64, currencyID int64, headers map[string]string) (response models.OperationResponseOfIEnumerableOfPaymentMethod, err error) {
	country := strconv.FormatInt(countryID, 10)
