...
type GameFilterModel struct {
	...
	Sort         *int    `json:"Sort,omitempty"`         // (Optional) Result sort order. Default = Alphabetic. 0 = Alphabetic, 1 = Popularity, 2 = Vendor
	Device       *int    `json:"Sort,omitempty"`         // (Optional) Filter by device. Default = Device From User Agent. 1 = Desktop, 2 = iPad, 3 = iPhone, 4 = Android Phone, 5 = Windows Mobile 7, 6 = Windows Mobile 8, 7 = iPod, 8 = AndroidTablet.
