...
type UserObject struct {
	...
	GamMatrixUserID                *int     `json:"GamMatrixUserID,omitempty"`    // The GamMatrix User ID. The User ID of GamMatrix
	...
	LoginTries                     *int     `json:"LoginTries,omitempty"`         // The number of login tries
	...
	DepositCount                   *int     `json:"DepositCount,omitempty"`    // The Deposit Count
