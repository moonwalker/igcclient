...
type RegistrationData struct {
	VerificationTypeID     *int                        `json:"VerificationTypeID"`               // VerificationTypeID from UserVerifyRegistrationTypes()
	...
	SexID                  *int                        `json:"SexID,omitempty"`                  // sex identifier
	...
	CountryID              *int                        `json:"CountryID,omitempty"`              // country identifier.
	LanguageID             *int                        `json:"LanguageID,omitempty"`             // language identifier.
	...
	SecurityQuestionID     *int                        `json:"SecurityQuestionID,omitempty"`     // security question identifier. set as 0 for not set.
	SecurityAnswer         *string                     `json:"SecurityAnswer,omitempty"`         // security answer
	CurrencyID             *int                        `json:"CurrencyID,omitempty"`             // currency identifier
