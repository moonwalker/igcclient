...
type QuickPayRequestModel struct {
	PaymentTypeId  *int     `json:"PaymentTypeId"`            // Always required. The PaymentTypeId
	...
	WalletCardId   *int     `json:"WalletCardId"`             // Always required. The Wallet Account or Card Id.
