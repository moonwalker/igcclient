...
func (s *GamesService) LastPlayed(maxResults int64, body GameUserInteractionDataModel, headers map[string]string) (response OperationResponseOfIEnumerableOfLastPlayed, err error) {
...
func (s *GamesService) Transactions(body GameTransactionsSearchModel, headers map[string]string) (response OperationResponseOfIEnumerableOfGameTransactionModel, err error) {
