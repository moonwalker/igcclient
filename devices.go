...
func (s *DevicesService) GetPlatform(body DevicesDetectionModel) (response OperationResponseOfDevicePlatformModel, err error) {
	err = s.client.apiPost("/devices/getplatform", &body, &response, nil)
	return
}
