...
func (s *ResponsibleGamingService) GetUserLimitHistory(authToken string) (response models.OperationResponseOfIEnumerableOfUserLimitResponse, err error) {
...
func (s *ResponsibleGamingService) GetUserLimits(authToken string) (response models.OperationResponseOfIEnumerableOfUserLimitResponse, err error) {
...
//No documentation available.
func (s *ResponsibleGamingService) GetLimits(authToken string) (response models.OperationResponseOfIEnumerableOfUserLimitResponse, err error) {
